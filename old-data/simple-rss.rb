# Copyright Lucas Carlson (lucas@rufy.com) - Released under the terms of the LGPL
# modified slightly for bbcnews code by John Leach
...
class SimpleRSS
  VERSION = "1.1"
    ...
    :'jf:author', :'jf:creationDate', :'jf:modificationDate'
	]
